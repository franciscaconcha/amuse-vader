...
class vaderInterface(CodeInterface, common.CommonCodeInterface):
	...
	def get_grid_column_density():
		...
		function.addParameter('i', dtype='int32', 
							  direction=function.IN)
		function.addParameter('column_density', dtype='float64',
							  direction=function.OUT)
...
#class vader(InCodeComponentImplementation):
class vader(common.CommonCode):

	def __init__(self, unit_converter = None, **options):
		self.unit_converter = unit_converter

		common.CommonCode.__init__(self,  vaderInterface(**options), **options)
		#InCodeComponentImplementation.__init__(self,  vaderInterface(**options), **options)


	#'''
	def define_state(self, object): 
		common.CommonCode.define_state(self, object)
		object.add_transition('END', 'INITIALIZED', 
							'initialize_code', False)

		object.add_transition('INITIALIZED', 'RUN', 
							'commit_parameters')
		...
		object.add_method('CHANGE_PARAMETERS_RUN', 
		...
		object.add_method('RUN', 'get_grid_column_density')
		object.add_method('RUN', 'set_grid_column_density')
		object.add_method('RUN', 'get_grid_pressure')
		object.add_method('RUN', 'set_grid_pressure')
		object.add_method('RUN', 'get_grid_internal_energy')
		object.add_method('RUN', 'set_grid_internal_energy')
		object.add_method('RUN', 'get_mass_source_out')
		object.add_method('RUN', 'get_energy_source_out')
	#'''
	...
	def define_methods(self, builder):
		...
		builder.add_method(
			...
			(builder.NO_UNIT, builder.NO_UNIT,
			 lenght, length,
			 builder.NO_UNIT, builder.NO_UNIT,
			 length, velocity, builder.NO_UNIT,),
			(builder.ERROR_CODE)
		)
